<!-- Banner -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:ff4d00,100:1e90ff&height=200&section=header&text=Brian%20Nzuki&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=35" />
</p>
...
🔹 [📚 Bookstore App](https://github.com/yourusername/bookstore) – MERN stack app for managing and selling books online.  
🔹 [🏠 SafeHouse](https://github.com/yourusername/safehouse) – Facility management application with email form functionality.  
🔹 [✋ Sign Language Interpreter (AI)](https://github.com/yourusername/sl-interpreter) – Real-time hand gesture recognition with Python + MediaPipe.  
